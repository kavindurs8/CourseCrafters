    ...
    <div style="width:100%;">
        <ul style="list-style-type: none; margin: 0; padding: 0; overflow: hidden; background-color: #000000; width: 100%;">
            <li style="float: left; padding-left: 30px; height: 80px;">
                <a href="courseReviewerHome.php" style="display: block; height: 100%;">
            ...
            <li style="float: left; padding-top: 20px;">
                <a class="active" href="courseReviewerHome.php" style="display: block; color: white; text-align: center; padding: 14px 16px; text-decoration: none; background-color: #45a049; border-radius: 20px;">
                    Course Reviewer Home
                </a>
            </li>
            ...
            echo <<<HTML
                <a href="course_Reviewer.php?class_id={$row['class_id']}" class="pending-course-item">
                    <div>
                        ...
                        <form action="courseReviwerApproveCoourse.php" method="post">
...
<div style="margin-top: 8%"><?php include 'footer.php'; ?></div>
